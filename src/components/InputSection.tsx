            ...
            <div className="space-y-4">
                <div className="relative group">
                    ...
                    <input
                        ...
                        className="w-full pl-12 pr-10 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all font-medium text-gray-700 placeholder:text-gray-400"
                    />
                    {source && (
                        <button
                            type="button"
                            onClick={() => setSource('')}
                            className="absolute right-3 top-3 text-gray-400 hover:text-gray-600 p-1 hover:bg-gray-100 rounded-lg transition-all"
                        >
                            <X size={18} />
                        </button>
                    )}
